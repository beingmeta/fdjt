...
(function(){
  ...
  function tab_onclick(evt,shownclass){
    if (!(shownclass)) shownclass="fdjtshown";
	...
	if ((node.nodeType===1) && (cid=node.getAttribute("contentid"))) {
  ...
  function select_tab(tabbar,contentid,shownclass){
	...
	addClass(tab,shownclass);
      else if (hasClass(tab,"shown")) {
