...
(function(){
    ...
    function tab_onclick(evt,shown){
	if (!(shown)) shown="shown";
	var elt=fdjtUI.T(evt);
	if (elt) {
	    while (elt.parentNode)
		if (elt.getAttribute("contentid")) break;
	...
	if (fdjtID(contentid))
	    fdjtID(contentid).setAttribute("shown","shown");
